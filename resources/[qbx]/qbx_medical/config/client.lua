...
return {
    ...
    bleedDamageTimer = 4, -- The base damage that is multiplied by bleed level everytime a bleed tick occurs
    advanceBleedTimer = 10, -- How many bleed ticks occur before bleed level increases
    bleedTickRate = 90, -- How much time, in seconds, between bleed ticks
    ...
    headInjuryTimer = 10, -- How much time, in seconds, do head injury effects chance occur
    ...
    headInjuryChance = 5, -- The chance, in percent, that head injury side-effects get applied
    ...
    forceInjury = 50, -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
    healthDamage = 15, -- Minimum damage done to health before checking for injuries
    ...
    staggerAreas = {
        SPINE = { armored = true, major = 50, minor = 15 },
        UPPER_BODY = { armored = false, major = 50, minor = 15 },
        LLEG = { armored = true, major = 80, minor = 65 },
        RLEG = { armored = true, major = 80, minor = 65 },
        LFOOT = { armored = true, major = 80, minor = 70 },
        RFOOT = { armored = true, major = 80, minor = 70 },
    },
    ...
    alwaysBleedChance = 25, -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
