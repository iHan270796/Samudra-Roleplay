Config = {
    ...
    ItemRewards = {
    weed_box = {item = 'joint', amount = 2},
    heroin_box = {item = 'heroin', amount = 2},
    coke_box = {item = 'coke_brick', amount = 2},
    },
    -- allowedZones = {
    -- { coords = vector3(103.99, -1940.23, 20.8), radius = 150.0 }
    -- --{ coords = vector3(-1800.0, 450.0, 128.0), radius = 100.0 }
    -- },
    -- cityPoint = vector3(103.99, -1940.23, 20.8), --set cityPoint to false to disable
    cityPoint = false,
    notify = {
        title = 'Drugs',
