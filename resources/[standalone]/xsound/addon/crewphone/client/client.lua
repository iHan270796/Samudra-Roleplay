if config.AddonList.crewPhone then
    ...
    RegisterNetEvent('client-muzik-cal', function(pos, muzikAdi, link, serverId, mp3)
    ...
    RegisterNetEvent('client-muzik-durdur', function(muzikAdi)
    ...
    RegisterNetEvent('client-muzik-duraklat', function(muzikAdi)
        if tostring(GetPlayerServerId(PlayerId())) ~= muzikAdi then
    ...
    RegisterNetEvent('client-muzik-devamet', function(muzikAdi)
        if tostring(GetPlayerServerId(PlayerId())) ~= muzikAdi then
