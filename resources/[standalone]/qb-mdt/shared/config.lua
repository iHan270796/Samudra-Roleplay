...
-- However, if you're using a different inventory system, please refer to the "Inventory Edit | Automatic Add Weapons with images" section in qb-mdt's README.
Config.InventoryForWeaponsImages = "qs-inventory"

-- "LegacyFuel", "lj-fuel", "qb-fuel"
Config.Fuel = "lc_fuel"
...
Config.PenalCode = {
    [1] = {
        [1] = {title = 'Melebihi Batas Kecepatan', class = 'Misdemeanor', id = 'P.C. 1001', months = 0, fine = 70000, color = 'green', description = '( Speeding Violation )'},
        [2] = {title = 'Melanggar Rambu lalu lintas', class = 'Misdemeanor', id = 'P.C. 1002', months = 0, fine = 100000, color = 'green', description = ' ( Breaking a traffic light )'},
        [3] = {title = 'Parkir Sembarangan', class = 'Misdemeanor', id = 'P.C. 1003', months = 0, fine = 50000, color = 'green', description = '( Parking Violation )'},
        [4] = {title = 'Mengemudi Ugal-Ugalan', class = 'Misdemeanor', id = 'P.C. 1004', months = 0, fine = 200000, color = 'green', description = ' ( Reckless Driving )'},
        [5] = {title = 'Modifikasi Ilegal Pada Kendaraan', class = 'Misdemeanor', id = 'P.C. 1005', months = 0, fine = 150000, color = 'green', description = '( Illegal Modifications On Vehicles )'},
        [6] = {title = 'Balapan Jalanan', class = 'Felony', id = 'P.C. 1006', months = 5, fine = 250000, color = 'green', description = '( Street Racing )'},
        [7] = {title = 'Mengemudi Tanpa Lisensi/Tidak Valid/Habis Masa Berlaku ', class = 'Felony', id = 'P.C. 1007', months = 0, fine = 200000, color = 'green', description = '(Driving without a Valid License/Suspended )'},
        -- [8] = {title = 'Masuk Tanpa Izin di Zona Tertentu', class = 'Felony', id = 'P.C. 1008', months = 15, fine = 250000, color = 'red', description = '(Trespassing within a Restricted Zone)'},
        -- [9] = {title = 'Berada di area illegal', class = 'Felony', id = 'P.C. 1009', months = 10, fine = 125000, color = 'red', description = '(prohibited area)'},
        -- [10] = {title = 'Kepemilikan Alat Perampokan', class = 'Felony', id = 'P.C. 1010', months = 10, fine = 150000, color = 'red', description = '( Possession Of Robbery Tools )'},
        -- [11] = {title = 'Perencanaan Tindak Kriminal', class = 'Felony', id = 'P.C. 1011', months = 10, fine = 325000, color = 'red', description = '(Criminal Action Planning)'},
        -- [12] = {title = ' Perampokan bersenjata', class = 'Felony', id = 'P.C. 1012', months = 15, fine = 400000, color = 'red', description = '( Armed Robbery )'},
        -- [13] = {title = 'Perampokan Toko', class = 'Felony', id = 'P.C. 1013', months = 15, fine = 850000, color = 'red', description = '(Store Robbery)'},
        -- [14] = {title = 'Perampokan perhiasan', class = 'Felony', id = 'P.C. 1014', months = 25, fine = 1250000, color = 'red', description = ' ( Jewelry Robbery )'},
        -- [15] = {title = 'Perampokan Bank', class = 'Misdemeanor', id = 'P.C. 1015', months = 35, fine = 1950000, color = 'green', description = '( Minor Bank Robbery )'},
        -- [16] = {title = 'Perampokan Pacific Bank', class = 'Felony', id = 'P.C. 1016', months = 40, fine = 2500000, color = 'orange', description = '(Big Bank Robbery)'},
    ...
    [2] = {
        [1] = {title = 'Masuk Tanpa Izin di Zona Tertentu', class = 'Felony', id = 'P.C. 1008', months = 15, fine = 250000, color = 'red', description = '(Trespassing within a Restricted Zone)'},
        [2] = {title = 'Berada di area illegal', class = 'Felony', id = 'P.C. 1009', months = 10, fine = 125000, color = 'red', description = '(prohibited area)'},
        [3] = {title = 'Kepemilikan Alat Perampokan', class = 'Felony', id = 'P.C. 1010', months = 10, fine = 150000, color = 'red', description = '( Possession Of Robbery Tools )'},
        [4] = {title = 'Perencanaan Tindak Kriminal', class = 'Felony', id = 'P.C. 1011', months = 10, fine = 325000, color = 'red', description = '(Criminal Action Planning)'},
        [5] = {title = ' Perampokan bersenjata', class = 'Felony', id = 'P.C. 1012', months = 15, fine = 400000, color = 'red', description = '( Armed Robbery )'},
        [6] = {title = 'Perampokan Toko', class = 'Felony', id = 'P.C. 1013', months = 15, fine = 850000, color = 'red', description = '(Store Robbery)'},
        [7] = {title = 'Perampokan perhiasan', class = 'Felony', id = 'P.C. 1014', months = 25, fine = 1250000, color = 'red', description = ' ( Jewelry Robbery )'},
        [8] = {title = 'Perampokan Bank', class = 'Felony', id = 'P.C. 1015', months = 35, fine = 1950000, color = 'red', description = '( Minor Bank Robbery )'},
        [9] = {title = 'Perampokan Pacific Bank', class = 'Felony', id = 'P.C. 1016', months = 40, fine = 2500000, color = 'red', description = '(Big Bank Robbery)'},
        [10] = {title = 'Pencurian Kendaraan', class = 'Felony', id = 'P.C. 2010', months = 10, fine = 375000, color = 'red', description = '( Grand Theft Auto )'},
        [11] = {title = 'Pemerasan / pembegalan', class = 'Felony', id = 'P.C. 2011', months = 10, fine = 325000, color = 'red', description = ' ( Extortion )'},
        [12] = {title = 'Pemalsuan Identitas', class = 'Felony', id = 'P.C. 2012', months = 10, fine = 427000, color = 'red', description = '(Identity Fraud)'},
        [13] = {title = 'Memberikan informasi Palsu', class = 'Felony', id = 'P.C. 2013', months = 10, fine = 250000, color = 'red', description = '(Providing False information)'},
        [14] = {title = 'Perusakan', class = 'Felony', id = 'P.C. 2014', months = 10, fine = 175000, color = 'red', description = '(Vandalism)'},
        [15] = {title = 'Gagal Mengidentifikasi Diri Anda', class = 'Felony', id = 'P.C. 2015', months = 10, fine = 250000, color = 'red', description = '( Failed to Identify Yourself )'},
        [16] = {title = 'Kerusuhan', class = 'Felony', id = 'P.C. 2016', months = 10, fine = 345000, color = 'red', description = '(Unrest)'},
        [17] = {title = 'Penganiayaan Warga', class = 'Felony', id = 'P.C. 2017', months = 10, fine = 360000, color = 'red', description = '(Persecution of Citizens)'},
        [18] = {title = 'Penganiayaan Anggota Instansi', class = 'Felony', id = 'P.C. 2018', months = 15, fine = 450000, color = 'red', description = '(Persecution of Institution Members)'},
        [19] = {title = 'Penyerangan Terhadap warga', class = 'Felony', id = 'P.C. 2019', months = 10, fine = 375000, color = 'red', description = '(Attacks on residents)'},
        [20] = {title = 'Penyerangan Terhadap Anggota Instansi', class = 'Felony', id = 'P.C. 2019', months = 15, fine = 465000, color = 'red', description = '(Attacks Against Institution Members)'},
        [21] = {title = 'Peperangan', class = 'Felony', id = 'P.C. 2019', months = 10, fine = 500000, color = 'red', description = '(Gang War)'},
    },
    [3] = {
