return {
    ...
    pauseMapText = 'Samudra Roleplay', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        ...
        appId = '1420752703235297290', -- This is the Application ID (Replace this with you own)

        largeIcon = { -- To set this up, visit https://forum.cfx.re/t/how-to-updated-discord-rich-presence-custom-image/157686
            icon = 'samudra', -- Here you will have to put the image name for the 'large' icon.
            text = 'Samudra Roleplay', -- Here you can add hover text for the 'large' icon.
        },

        smallIcon = {
            icon = 'samudra', -- Here you will have to put the image name for the 'small' icon.
            text = 'Samudra Roleplay', -- Here you can add hover text for the 'small' icon.
        },

        firstButton = {
            text = 'Samudra Discord',
            link = 'https://discord.gg/CMqbkQWFG7',
        },

        secondButton = {
            text = 'Connect Server',
            link = 'fivem://connect/103.42.116.170:30120',
        }
    },
