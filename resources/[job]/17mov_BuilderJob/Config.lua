...
Config.Clothes = {
    ...
    male = {
        ...
        ["arms"] = {clotheId = 199, variation = 0},
        ["pants"] = {clotheId = 9, variation = 4},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 128, variation = 2},
        ["t-shirt"] = {clotheId = 98, variation = 1},
        ["torso"] = {clotheId = 0, variation = 2},
        ["decals"] = {clotheId = 0, variation = 0},
        ["kevlar"] = {clotheId = 0, variation = 0},
    },

    maleHelmet = { clotheId = 184, variation = 1},

    female = {
        ["mask"] = {clotheId = 0, variation = 0},
        ["arms"] = {clotheId = 14, variation = 0},
        ["pants"] = {clotheId = 1, variation = 1},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 50, variation = 0},
        ["t-shirt"] = {clotheId = 71, variation = 1},
        ["torso"] = {clotheId = 162, variation = 1},
        ["decals"] = {clotheId = 12, variation = 5},
        ["kevlar"] = {clotheId = 0, variation = 0},
    },

    femaleHelmet = { clotheId = 149, variation = 1},
}
...
Config.Lang = {
    ...
    ["nobodyNearby"] = "Tidak Ada Player Di Dekat Anda",
    ...
    ["workstationOccupied"] = "Tempat kerja sudah terisi",
    ...
    ["reward"] = "Kamu Menerima Gaji Sebesar RP",
    ...
    ["someoneIsOnCooldown"] = "%s Tidak dapat memulai pekerjaan sekarang (cooldown: %s)",
    ["hours"] = "h",
    ["minutes"] = "m",
    ["seconds"] = "s",
...
Config.JobBlipsStyle = {
    ["mixerSpawnLocation"] = {
        color = 47,
        string = "~o~[Kuli]~s~ Pengambilan Melon Beton",
        sprite = 800,
    },
    ["mixerTargetLocation"] = {
        color = 47,
        string = "~o~[Kuli]~s~ Lokasi Pengiriman Melon Beton",
        sprite = 652,
    },
    ["installPipe"] = {
        color = 47,
    ...
    ["buildWall"] = {
        color = 47,
        string = "~o~[Kuli]~s~ Bangun Tembok",
        sprite = 285,
    },

    ["welding"] = {
        color = 47,
        string = "~o~[Kuli]~s~ Pengelasan",
        sprite = 468,
    },
}
    ...
    [1] = {
        ...
        walls = {
            [1] = {
                ...
                blocksSpawnLocation = vector3(-460.28, -1057.63, 39.15),
            ...
            [2] = {
                ...
                blocksSpawnLocation = vector3(-455.19, -1059.92, 39.15),
                blocksSpawnRotation = vector3(-90.0, 0.0, 0.0),
                blocksInFrameLocations = {
    ...
    [2] = {
        ...
        customTasks = {
            ...
            [1] = {
                ...
                drawingText = "Buat Jalan Untuk Melon Beton",                                        -- This string will be drawed above coords in this Style: [E] | *text*
