...
-- Get safe config for NUI to avoid JSON serialization issues
function GetSafeConfigForNUI()
  return {
    Currency = Config.Currency,
    NumberAndDateFormat = Config.NumberAndDateFormat,
    SpeedUnit = Config.SpeedUnit,
    HideVehicleStats = Config.HideVehicleStats,
    ShowVehicleImages = Config.ShowVehicleImages,
    FinancePayments = Config.FinancePayments,
    FinanceDownPayment = Config.FinanceDownPayment,
    FinanceInterest = Config.FinanceInterest,
    TestDriveTimeSeconds = Config.TestDriveTimeSeconds,
    Framework = Config.Framework,
    PlateFormat = Config.PlateFormat,
    MyFinanceCommand = Config.MyFinanceCommand,
    DirectSaleCommand = Config.DirectSaleCommand,
    DealerAdminCommand = Config.DealerAdminCommand,
    Categories = Config.Categories,  -- Add Categories to fix NUI error
    VehicleColourOptions = Config.VehicleColourOptions,  -- Add color options for UI
    UseRGBColors = Config.UseRGBColors  -- Add RGB flag
  }
end