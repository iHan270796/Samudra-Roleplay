...
Config.DisplayVehiclePersistenceCheck = true -- Enable periodic persistence checks for display vehicles
...
Config.VehicleColourOptions = {
  {label = "Red", hex = "#e81416", index = 27, rgb = {232, 20, 22}},
  {label = "Orange", hex = "#ff7518", index = 38, rgb = {255, 117, 24}},
  {label = "Yellow", hex = "#ffbf00", index = 88, rgb = {255, 191, 0}},
  {label = "Green", hex = "#79c314", index = 92, rgb = {121, 195, 20}},
  {label = "Blue", hex = "#487de7", index = 64, rgb = {72, 125, 231}},
  {label = "Purple", hex = "#70369d", index = 145, rgb = {112, 54, 157}},
  {label = "Black", hex = "#000000", index = 0, rgb = {0, 0, 0}},
  {label = "White", hex = "#ffffff", index = 111, rgb = {255, 255, 255}},
}

Config.Categories = {
  dealershipsport = "Sports",
  dealershipsupercar = "Supercar",
  dealershipmotors = "Motors",
  dealershipcompact = "Compact",
  dealershipclassic = "Classic",
  dealershipmuscle = "Muscle",
  dealershipcoupe = "Coupes",
  dealershipsedan = "Sedans",
  dealershipoffroad = "Offroad",
  dealershipsuv = "SUVs",
  dealershippickup = "Pickup",
  luxurymotors = "L Motors",
  luxurysports = "L Sports",
  luxurysupercar = "L Supercar",
  luxuryclassic = "L Classic",
  luxuryoffroad = "L Offroad",
  JDM = "JDM"
}
...
Config.DealershipLocations = {
  ["Dealership"] = {
    ...
    categories = {"dealershipsport", "dealershipsupercar", "dealershipcompact", "dealershipmotors", "dealershipclassic", "dealershipmuscle", "dealershipcoupe", "dealershipsedan", "dealershipoffroad", "dealershipsuv", "dealershippickup"},
  ...
  ["DealerLuxury"] = {
    type = "self-service", -- or "owned", "self-service"
    openShowroom = {
      coords = vector3(127.46, -144.17, 54.84),
      size = 5
    },
    openManagement = {
      coords = vector3(148.48, -141.99, 54.8),
      size = 5
    },
    sellVehicle = {
      coords = vector3(120.87, -128.82, 54.84),
      size = 5
    },
    purchaseSpawn = vector4(116.13, -141.46, 54.8, 340.99),
    testDriveSpawn = vector4(103.68, -139.11, 54.75, 161.43),
    camera = {
      name = "Car",
      coords = vector4(-146.6166, -596.6301, 166.0, 270.0),
      positions = {5.0, 8.0, 12.0, 8.0}
    },
    categories = {"luxurymotors", "luxurysports", "luxurysupercar", "luxuryclassic", "luxuryoffroad"},
    enableTestDrive = true,
    hideBlip = false,
    blip = {
      id = 326,
...
Config.Debug = false -- Enable debug to track color issues