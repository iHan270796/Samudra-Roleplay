...
Config.CatchAliveChicken = {
    ["label"] = "farming Ayam", --name of blips
    ...
    ["amount_alive_chicken_to_give"] = 1, -- amount of chicken to give player
...
Config.SpawnChicken = {
    ...
    ["quantity"] = { -- where and how many chicken should spawn?
        ...
        [6] = {
            ["coords"] = vector4(2373.15, 5059.1, 46.44, 249.26),
        },
        [7] = {
            ["coords"] = vector4(2379.192, 5062.992, 46.444, 195.477),
        },
...
Config.SlaughteredChicken = {
    [1] = {
        ["label"] = "Prosess Ayam", -- name of blips
...
Config.PackagedChicken = {
    [1] = {
        ...
        ["coords"] = vector3(-100.67, 6211.36, 30.94), -- where should this spot be?
        ...
        ["amount_packaged_chicken_to_give"] = 2, -- amount of packaged chicken to give player at a time
        ["processing_time"] = 7000, -- how long should processing take?
        ["displayBlip"] = true, -- should blips be displayed?
        ["blipColor"] = 46, -- color of blips
        ["blipScale"] = 0.8, -- scale of blips
    ...
    [2] = {
        ...
        ["coords"] = vector3(-102.98, 6209.36, 30.95),
        ["heading"] = 40.0,
        ["amount_slaughtered_chicken_to_remove"] = 1,
        ["amount_packaged_chicken_to_give"] = 2,
        ["processing_time"] = 7000,
        ["displayBlip"] = false,
        ["blipColor"] = 46,
        ["blipScale"] = 0.8,
    ...
    [3] = {
        ["label"] = "Chicken packing",
        ["coords"] = vector3(-104.5, 6207.56, 30.94),
        ["heading"] = 40.0,
        ["amount_slaughtered_chicken_to_remove"] = 1,
        ["amount_packaged_chicken_to_give"] = 2,
        ["processing_time"] = 7000,
