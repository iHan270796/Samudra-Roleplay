    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className={"absolute -bottom-6 w-full flex gap-3 items-center justify-start"}>
            <div className={"flex flex-col w-2/4 items-center justify-center gap-1"}>
              <StatBarSegmented Icon={BiSolidShieldAlt2} value={playerState.armor} color="#2b39fcff" />
              <StatBar Icon={TiHeartFullOutline} value={playerState.health} color="#0656ce" maxValue={100} />
            </div>
            {isUsingFramework && (
              <>
