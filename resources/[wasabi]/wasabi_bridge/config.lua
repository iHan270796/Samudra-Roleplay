...
Config.Notifications = {
    defaults = {                                    -- Default notification settings
        position = 'center',                     -- position options: 'center', 'top-right', 'top-left', 'right', 'left', 'bottom-right', and 'bottom-left'
        time = 5500,                                -- Time in MS to show notifications by default if not defined
...
Config.TextUISettings = {
    position = 'left-center',   -- Position of the text UI ('right-center', 'left-center', 'top-center', or 'bottom-center')
