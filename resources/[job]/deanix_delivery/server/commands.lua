RegisterCommand(Config.Commands.tabletCommand, function(source)
    local src = source
    TriggerClientEvent("deanix_delivery:Client:OpenTablet", src)
end)

RegisterCommand(Config.Commands.acceptInv, function(source)
    local src = source
    TriggerClientEvent("deanix_delivery:Client:AcceptInvitation", src)
end)

RegisterCommand(Config.Commands.denyInv, function(source)
    local src = source
    TriggerClientEvent("deanix_delivery:Client:DenyInvitation", src)
end)

RegisterCommand(Config.Commands.blockInvitations, function(source)
    local src = source
    TriggerClientEvent("deanix_delivery:Client:BlockInvitations", src)
end)

RegisterCommand(Config.Commands.leaveteam, function(source)
    local src = source
    TriggerClientEvent("deanix_delivery:Client:LeaveCurrentTeam", src)
end)
