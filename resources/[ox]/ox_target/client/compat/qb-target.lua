--[[
    QB-Target Compatibility Layer for ox_target
    This module provides compatibility functions to convert QB-Target calls to ox_target format
]]

-- Helper function to register exports
...
---Converts QB-Target options to ox_target format
---@param options table The options table to convert
---@return table Converted options table
local function convert(options)
    local distance = options.distance
    options = options.options

    -- Convert hashmap options to array format
    ...
    for id, v in pairs(options) do
        ...
        -- Convert QB-Target specific properties to ox_target format
        v.onSelect = v.action
        ...
        -- Handle groups/job requirements
        ...
        -- Clean up QB-Target specific properties
        v.action = nil
        v.job = nil
        v.gang = nil
        v.citizenid = nil
