...
RegisterNetEvent("deanix_delivery:Client:HandleCallback", function(key, ...)
...
RegisterNetEvent("deanix_delivery:Client:ToggleDeliveryJobDuty", function()
...
RegisterNetEvent("deanix_delivery:Client:OpenTablet", function()
...
RegisterNetEvent("deanix_delivery:Client:NewInvitationArrived", function(invitingSource, invitingName)
    Koci.Client.Functions.HandleNewInvitation(invitingSource, invitingName)
end)

RegisterNetEvent("deanix_delivery:Client:AcceptInvitation", function()
...
RegisterNetEvent("deanix_delivery:Client:DenyInvitation", function()
...
RegisterNetEvent("deanix_delivery:Client:BlockInvitations", function()
    Koci.Client.Functions.BlockInvitations()
end)

RegisterNetEvent("deanix_delivery:Client:TargetAcceptedInvitation", function(invited, invitedData)
...
RegisterNetEvent("deanix_delivery:Client:PlayerLeaveYourTeam", function(leavingSourceId, leavingName)
...
RegisterNetEvent("deanix_delivery:Client:LeaveCurrentTeam", function()
    if Koci.Client.Functions.GetMateCount() == 0 then
...
RegisterNetEvent("deanix_delivery:Client:StartTask", function(taskId, isLeader)
    if Koci.Client.Player.onTask then return end
    Koci.Client.Functions.StartNewTask(taskId, isLeader)
end)

RegisterNetEvent("deanix_delivery:Client:OnTaskVehicleCreated", function(netId, plate, coords)
    Koci.Client.Functions.OnTaskVehicleCreated(netId, plate, coords)
end)

RegisterNetEvent("deanix_delivery:Client:UpdateCurrentTaskCustomers", function(newDestinations)
    Koci.Client.Functions.SendTaskCustomers(newDestinations)
end)

RegisterNetEvent("deanix_delivery:Client:OnCargoPickUpFromTaskVehicle", function(playerSource)
    Koci.Client.Functions.OnCargoPickUpFromTaskVehicle(playerSource)
end)

RegisterNetEvent("deanix_delivery:Client:OnCargoPutOnTaskVehicle", function(playerSource)
    Koci.Client.Functions.OnCargoPutOnTaskVehicle(playerSource)
end)

RegisterNetEvent("deanix_delivery:Client:StartNewTaskDestination", function(newDestination, model)
    Koci.Client.Functions.StartTaskDestination(newDestination, model)
end)

RegisterNetEvent("deanix_delivery:Client:OnTaskDestionCompleted", function(prop)
    Koci.Client.Functions.OnTaskDestionCompleted(prop)
end)

RegisterNetEvent("deanix_delivery:Client:HandOverTaskVehicle", function()
    Koci.Client.Functions.Thread_HandOverTaskVehicle()
end)

RegisterNetEvent("deanix_delivery:Client:OnTaskCompleted", function(newLevel, newExp)
    Koci.Client.Functions.OnTaskCompleted(newLevel, newExp)
end)

RegisterNetEvent("deanix_delivery:Client:OnCargoPickUpFromDestinationPed", function()
