...
RegisterNetEvent('QBCore:Notify', function(text, notifyType, duration, subTitle, notifyStyle, notifyIcon, notifyIconColor)
    Notify(text, notifyType, duration, subTitle, notifyStyle, notifyIcon, notifyIconColor)
end)
