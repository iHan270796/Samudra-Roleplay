...
Config.JerryCan = {
    ...
    price = 30000,				-- Price to purchase it
...
Config.PlayerOwnedGasStations = {
    ...
    gasStations = {				-- This list is the vector3 + radius of center of the gas pumps area, so the script can know which gas pump is from which gas station
        ...
        ["gas_station_28"] = {
            vector = vector3(60.51, -372.58, 39.13),
            radius = 30
        },
        ["gas_station_29"] = {
            vector = vector3(59.24, -372.22, 38.13),
            radius = 30
        }
    }
}
...
Config.CustomGasPumpLocations = {
    ...
    { prop = "prop_gas_pump_1a", location = vector4(59.24, -372.22, 38.13, 74.58), ropeLength = 14.0 },
}
...
Config.Electric = {
    ...
    chargeTypes = {
        fast = {
            price = 450,				-- Price per 1% recharged
