...
Locales['vi'] = {
  ...
  -- Missing keys
  dealershipNotEnoughFunds = "Đại lý không đủ tiền",
  dealershipVehiclesOrdered = "Xe đã được đặt hàng thành công",
  dealershipOrderPlaced = "%{value} xe đã được đặt hàng thành công",
  dealershipOrderCancelled = "Đơn hàng đã được hủy thành công"
}
