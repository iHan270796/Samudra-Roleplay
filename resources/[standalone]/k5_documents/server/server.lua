...
RegisterServerEvent('k5_documents:createServerDocument', function(data)
  local src = source
  local PlayerIdentifier = GetPlayerIdentifier(src)
...
RegisterServerEvent('k5_documents:giveCopy', function(data, targetId)
  local src = source
  local tsrc = targetId
...
RegisterServerEvent("k5_documents:receiveDocument", function(data, targetId)
  local tsrc = targetId
