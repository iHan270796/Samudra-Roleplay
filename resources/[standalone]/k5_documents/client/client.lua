...
RegisterNetEvent('k5_documents:copyGave', function(data)
	holdDocument(false)
  playAnim("mp_common", "givetake1_a", 1500)
  Notification(Config.Locale.giveNotification .. " " .. data)
end)

RegisterNetEvent("k5_documents:useItem", function()
	toggleNuiFrame(true, true)
end)


RegisterNetEvent('k5_documents:copyReceived', function(data)
  Notification(Config.Locale.receiveNotification .. " " .. data)
end)

RegisterNetEvent('k5_documents:viewDocument', function(data)
...
function playerSelector(confirmText)
  ...
  while selectingPlayer do
    ...
    exports["deanix_textui"]:Show("[E] " .. confirmText, "[ESC] " .. Config.Locale.cancel)
  ...
  -- Pastikan text UI ditutup jika loop selesai secara tidak normal
  exports["deanix_textui"]:Close()
end
