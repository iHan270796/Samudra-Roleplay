...
lib.callback.register('xt-prison:client:enterJail', function(setTime)
    -- Tampilkan countdown jail time
    exports["deanix_textui"]:ShowCountdown(
        "⛓️ JAIL TIME",
        "🅳🅴🅰🅽🅸🆇 ᴘʀɪsᴏɴ sʏsᴛᴇᴍ\nYou are currently in jail.\nComplete your sentence before release.",
        setTime * 60 -- konversi menit ke detik
    )
...
lib.callback.register('xt-prison:client:exitJail', function(isUnjailed)
    -- Hentikan countdown setelah keluar
    exports["deanix_textui"]:StopCountdown()
