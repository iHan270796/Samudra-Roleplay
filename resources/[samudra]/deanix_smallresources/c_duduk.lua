...
Config.GetUpKey = 51 --https://docs.fivem.net/docs/game-references/controls/
...
Config.Objects = {
    ...
    --bahamas
    [1850701663]		= { type = "sit", offsets = vector3(0.05, -0.05, 0.75), heading = 180.0},
    [954232759]		= { type = "sit", offsets = vector3(0.0, 0.0, 0.5), heading = 180.0},
}

Config.Zones = {
    {
        name = "bahamas_stage_1",
        coords = vec3(-1402.12, -619.21, 30.06),
        size = vec3(1.2, 1.0, 1.2),
        heading = 306.86,
        type = "sit",
        offsets = vector3(0.0, 0.0, -0.05),
        debug = false
    }
    -- {
    --     name = "vip_spot_1",
    --     coords = vec3(-1380.2, -618.8, 30.3),
    --     size = vec3(1.0, 1.0, 1.0),
    --     heading = 180.0,
    --     type = "sit",
    --     offsets = vector3(0.0, 0.0, 0.6),
    --     debug = true
    -- }
}
...
Config.Texts = {
    ["use"] = "Duduk",
    ["already_sit"] = "Anda Sedang Duduk!",
    ["seat_taken"] = "Kursi ini Penuh!",
    ["get_up"] = "Tekan [E] Untuk Berdiri"
}
