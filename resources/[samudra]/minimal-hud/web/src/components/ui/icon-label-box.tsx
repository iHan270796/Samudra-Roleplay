...
const IconLabelBox: React.FC<IconLabelBoxProps> = ({ Icon: Icon = FaCompass, label = "NW", className = "", textClassName = "", iconClassName = "", ...props }) => {
  return (
    <div className={twMerge(`flex items-center h-[2.5dvh] justify-center text-y_white rounded-[8px] p-[1px] min-w-[5dvw]`, className)} style={{ backgroundColor: "#38b1ee47" }} {...props}>
