...
Config.Target = true -- enable this if you want use target Do not turn on the target, it will work the day after the release.
...
Config.ServerSideObjectsOnly = false -- enable this feature only if you are using entity lockdown (strict mode) on the server, all objects will be created via serverside.
...
Config.AttractionsSettings = {
	gforce = {
		...
		ticketprice = 25000, -- price for ticket
	...
	bumpercars = {
		...
		priceperminute = 10000, -- price for ticket per minute
