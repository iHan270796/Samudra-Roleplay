...
-- RegisterNetEvent('rst-starterpack:client:chooseVehicleMenu', function(gender)
--     local PlayerData = QBCore.Functions.GetPlayerData()

--     if not PlayerData.metadata["starterpack"] then
--         lib.notify({ title = 'Starterpack', description = "You haven't claimed the Starterpack yet!", type = 'error' })
--         return
--     end

--     if PlayerData.metadata["starterpack2"] then
--         lib.notify({ title = 'Starterpack', description = "You have selected the 2nd Starterpack vehicle.", type = 'error' })
--         return
--     end

--     local vehicleList = (gender == 0) and Config.ChooseVehicleMale or Config.ChooseVehicleFemale
