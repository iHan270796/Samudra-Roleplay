...
function functions.Notify(source, text, notifyType, duration, subTitle, notifyStyle, notifyIcon, notifyIconColor)
    exports.qbx_core:Notify(source, text, notifyType, duration, subTitle, notifyStyle, notifyIcon, notifyIconColor)
end
