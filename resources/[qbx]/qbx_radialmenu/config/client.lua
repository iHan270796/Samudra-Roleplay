    ...
    menuItems = {
        ...
        },
        {
            ...
            items = {
                ...
                --         if veh ~= 0 then
                --             TriggerServerEvent("qbx_vehiclekeys:server:giveKeysToClosest", VehToNet(veh))
                --         else
                --             lib.notify({description = 'Kamu harus berada di dalam kendaraan', type = 'error'})
                --         end
                --     end
                -- },
                {
                ...
                items = {
                    {
                        ...
                        icon = 'fa-dog',
                        label = 'Follow',
                        event = 'elixir-k9:Follow',
                    },
                    {
                        id = 'police_in_outk9',
                        icon = 'fa-dog',
                        label = 'Get In/Out',
                        event = 'elixir-k9:EnterVeh',
                    },
                    {
                        id = 'police_sitk9',
                        icon = 'fa-dog',
                    ...
                    },
                    {
                        ...
                        icon = 'fa-dog',
                        label = 'Sniff Person',
                        event = 'elixir-k9:searchdude',
                    },
                    {
                        id = 'police_vehiclek9',
                        icon = 'fa-dog',
                        label = 'Sniff Vehicle',
                        event = 'elixir-k9:searchcar',
                    },
                    {
                        id = 'police_searchk9',
                        icon = 'fa-dog',
                        label = 'Search Area',
                        event = 'elixir-k9:searcharea',
                    },
                },
            },
        },
