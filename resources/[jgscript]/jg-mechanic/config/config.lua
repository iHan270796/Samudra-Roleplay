...
Config.MechanicLocations = {
  ...
  bennys = {  --paleto
    ...
    carLifts = { -- only usable by employees
      ...
      vector4(72.41, 6523.06, 31.72, 312.96),
      vector4(53.3, 6505.34, 31.72, 135.95)
    },
    shops = {
      {
        name = "Servicing Supplies",
      ...
      },
    {
      ...
      {
        name = "Servicing Supplies3",
        coords = vector3(30.16, 6546.57, 31.72),
        size = 2.0,
        usePed = false,
        grade = 2,
        pedModel = "s_m_m_lathandy_01",
      ...
      {
        name = "Advanced Upgrades3",
        coords = vector3(34.64, 6551.02, 31.72),
        size = 2.0,
        usePed = false,
        pedModel = "s_m_m_lathandy_01",
        grade = 2,
    ...
    stashes = {
      ...
      {
        name = "Parts Bin2",
        coords = vector3(25.46, 6541.85, 31.72),
        size = 2.0,
        usePed = false,
        pedModel = "s_m_m_lathandy_01",
        marker = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
