...
function functions.Notify(text, notifyType, duration, subTitle, notifyStyle, notifyIcon, notifyIconColor)
    exports.qbx_core:Notify(text, notifyType, duration, subTitle, notifyStyle, notifyIcon, notifyIconColor)
end
