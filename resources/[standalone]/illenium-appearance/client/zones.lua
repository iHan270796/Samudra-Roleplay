...
--     local allOutfits = Config.Outfits[job]
--     local outfits = {}

--     if allOutfits and allOutfits[gender] then
--         for _, outfit in ipairs(allOutfits[gender]) do
--             table.insert(outfits, {
--                 outfitLabel = outfit.name or "Unnamed Outfit",
