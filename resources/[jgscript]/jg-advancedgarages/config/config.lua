...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["Carnaval"] = { -- If you change the name of this garage from Legion Square, you must change the default value of `garage_id` to the same name in the SQL table `players_vehicles`
    coords = vector3(-1856.2, -1297.79, 3.01),
    spawn = {vector4(-1859.85, -1313.03, 3.01, 359.93), vector4(-1869.35, -1296.1, 3.01, 287.12), vector4(-1872.28, -1287.44, 3.01, 309.89), vector4(-1848.91, -1306.89, 3.01, 53.97)}, --  you can add multiple spawn locations into a table
    distance = 25,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Tukang Jahit"] = { -- If you change the name of this garage from Legion Square, you must change the default value of `garage_id` to the same name in the SQL table `players_vehicles`
    coords = vector3(706.59, -979.9, 24.14),
    spawn = {vector4(706.59, -979.9, 24.14, 222.12), vector4(702.82, -980.42, 24.14, 220.58)}, --  you can add multiple spawn locations into a table
    distance = 10,
    type = "car",
    hideBlip = false,
    blip = {
