...
Config.Framework = 'qbox' --auto | --qbox | --qb | --esx | --standalone
--[[
...
--[[
    Supported:
        ...
        * qs-inventory - Integration included, but do not supported by us.
        * codem-inventory - Integration included, but do not supported by us.
        * core_inventory- Integration included, but do not supported by us.
        * tgiann-inventory - Integration included, but do not supported by us.
--]]
