...
Config.HudSettings = {
    ...
    MinimapVisibleWhileWalking = false, -- "true" : Minimap Shows While Walking | "false" : Minimap Doesn't Show While Walking
    ...
    HudAlwaysOn = true, -- "true" : Hud Always Shows | "false" : Hud Doesn't Show Until Trigger Export. exports["samudra_hud"]:ToggleHud()
    WeaponUI = {
...
Config.Settings = {
    ...
    StressSettings = {
        ...
        UnbuckledSpeed = 150, -- Going over this speed cause stress
        MinimumSpeed = 200, -- Going over this speed cause stress
        JobWhitelist = {
            police = true,
            ambulance = true
        },
