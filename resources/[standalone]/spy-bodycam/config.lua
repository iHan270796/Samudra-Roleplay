...
Config.WatchLoc = {
    [1] = {
        coords = vector3(446.08, -998.81, 34.58), 
        rad = 1.5, 
        debug = false,
...
Config.VehCamOffset = {
    ['polchiron'] = {0.000000, 0.330000, 0.530000},
    --[''] = {0.000000, 0.510000, 0.630000},  -- Example vehicle. The script comes with its own offset finder just set DebugCamera to true and get the offset.
