...
RegisterNetEvent('rup-reportmenu:client:refreshReports', function()
...
RegisterNetEvent('rup-reportmenu:client:refreshMessages', function(reportId)
...
RegisterNetEvent('rup-reportmenu:client:deleteReportMedia', function(data)
