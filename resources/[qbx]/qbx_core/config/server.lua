return {
    ...
    money = {
        ...
        ---@type Money
        moneyTypes = { cash = 200000, bank = 250000, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
    ...
    logging = {
        webhook = {
            ['default'] = nil, -- default
            ['joinleave'] = 'https://discord.com/api/webhooks/1421138492779397232/4yCEePi4saK9JT0H26Pj2gMLX6s1WwoY-kfmBsUBx0hN82-8BwoK_k5jO1jcLin5LgVp', -- default
            ['ooc'] = nil, -- default
            ['anticheat'] = 'https://discord.com/api/webhooks/1327214247419183145/ud_BrpA7ncJDXQoeG_N-wstCshpy5erzN8fykuMr4mI4wbNh26fQ1oe2hJC6VF0tdOhc', -- default
            ['playermoney'] = 'https://discord.com/api/webhooks/1421173847897669734/xKqK-xEtLWTaOeqcik5cXyncrbJy_lu6DFZeSWbsBQvden2Rd_6eWUopZqLRPuJaQn9Z', -- default
        },
