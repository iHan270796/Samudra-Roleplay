MAKE SURE YOU HAVE THE OX INVENTORY CONFIG IN YOUR SERVER.CFG OR THERE WILL BE PROBLEMS
...
# Activate specific event handlers and functions (supported: ox, esx, qbx, qb, nd)
...
setr inventory:dropmodel "prop_paper_bag_small"
