...
Config.PresetChatThemes = {
    ooc = {
        ...
        leftBottomCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/ooc-left.png",
        rightTopCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/ooc-right.png",
        headerSrc = "nui://" .. GetCurrentResourceName() .."/images/ooc.png",
    },
    ems = {
        ...
        leftBottomCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/ems-left.png",
        rightTopCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/ems-right.png",
        logoSrc = "nui://" .. GetCurrentResourceName() .."/images/ems-logo.png", 
        headerSrc = "nui://" .. GetCurrentResourceName() .."/images/ems.png",
    },
    lspd = {
        ...
        leftBottomCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/lspd-left.png",
        rightTopCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/lspd-right.png",
        logoSrc = "nui://" .. GetCurrentResourceName() .."/images/lspd-logo.png",
        headerSrc = "nui://" .. GetCurrentResourceName() .."/images/lspd.png",
    },
    twt = {
    ...
    lscustom = {
        ...
        leftBottomCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/lscustoms-left.png",
        rightTopCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/lscustoms-right.png",
        logoSrc = "nui://" .. GetCurrentResourceName() .."/images/lscustoms-logo.png",
        headerSrc = "nui://" .. GetCurrentResourceName() .."/images/lscustoms.png",
    },
    yellowpages = {
        ...
        leftBottomCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/yellowpages-left.png",
        rightTopCurvedSrc = "nui://" .. GetCurrentResourceName() .."/images/yellowpages-right.png",
        logoSrc = "nui://" .. GetCurrentResourceName() .."/images/Logo-bahamas.png",
        headerSrc = "nui://" .. GetCurrentResourceName() .."/images/BAHAMAS.png",
    },
    pemerintah = {
