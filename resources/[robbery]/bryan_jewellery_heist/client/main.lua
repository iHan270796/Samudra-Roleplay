...
--     lib.array.forEach(Vitrines, function(vitrine)
--         exports['qb-target']:AddBoxZone("vitrine_" .. vitrine.id, -- unique name
--             applyOffset(vitrine.coords, vector3(0.0, 0.5, 0.0), vitrine.coords.w), -- coords
--             1.0, 0.5, -- width, length
--             {
--                 name = "vitrine_" .. vitrine.id,
--                 heading = vitrine.coords.w,
--                 debugPoly = false,
--                 minZ = vitrine.coords.z - 1.0,
--                 maxZ = vitrine.coords.z + 1.0,
--             },
--             {
--                 options = {
--                     {
...
-- exports['qb-target']:AddBoxZone("thermite_box",
--     vector3(Config.Locations.thermite.coords.x, Config.Locations.thermite.coords.y, Config.Locations.thermite.coords.z),
--     1.0, 1.0, -- sesuaikan ukuran sesuai kebutuhan Anda
--     {
--         name = "thermite_box",
--         heading = Config.Locations.thermite.coords.w,
--         debugPoly = false,
--         minZ = Config.Locations.thermite.coords.z - 1.0,
--         maxZ = Config.Locations.thermite.coords.z + 1.0,
--     },
--     {
--         options = {
--             {
--                 label = locale('blow_fuse_box'),
--                 icon = 'fas fa-bug',
--                 item = Config.Thermite.item, -- jika Anda ingin membatasi pakai item
--                 action = function()
--                     TriggerEvent('bryan_jewellery_heist:client:startThermite')
--                 end
--             }
--         },
--         distance = 2.0
